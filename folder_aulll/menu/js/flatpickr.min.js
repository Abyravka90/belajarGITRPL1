  ...
  function y(g, h) {
    ...
    function z(e, n) {
      ...
      (t < 0 && !0 === D._hidePrevMonthArrow) ||
        ...
        ((D.currentMonth += t), (D.currentMonth < 0 || D.currentMonth > 11) && ((D.currentYear += D.currentMonth > 11 ? 1 : -1), (D.currentMonth = (D.currentMonth + 12) % 12), ge("onYearChange"), J()), B(), ge("onMonthChange"), ve());
    }
    function G(e) {
